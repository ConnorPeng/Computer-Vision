...
from proj2_code.fundamental_matrix import signed_point_line_errors, skew
...
def optimize(p0, x_0s, x_1s):
    ...
    optimized_F = least_squares(objective_function, p0, method = 'lm', jac='2-point', args = (x_0s, x_1s)).x
    ##############################
