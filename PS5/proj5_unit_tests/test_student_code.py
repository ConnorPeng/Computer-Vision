...
def test_pairwise_distances():
    ...
    assert actual_distances.shape == test_distances.shape, "The shape of the pairwise distances must be of the form N x M"
    ...
    assert actual_distances_1.shape == test_distances_1.shape, "The shape of the pairwise distances must be of the form N x M"
